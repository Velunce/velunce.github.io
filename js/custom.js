...
(function($) {
    ...
    try {
        if(window.navigator.language=="zh-CN"){
            window.console && window.console.log && (console.log("Hi! 朋友，感谢您愿意调试简历代码。"),
            console.log("邮箱联系我 %c dapeng.v.zhang@outlook.com", "color:blue"),
            console.log("电话联系我 %c 18842635797", "color:blue"))
        }else{
            console.log("Mail to: velunce@outlook.com \nPhone Number: +86 18842635797")
        }
